...
from criterion import lineFinderCriterion
...
def main():
    ...
    데이터 불러오기
    '''
    train_dict, valid_dict = train_valid_split('./data/processed/data.json', 0.9, 0.1)
    ...
    데이터 로더 만들기
    '''
    train_loader = DataLoader(train_dataset, batch_size=8, num_workers=1, pin_memory=True, shuffle=True, drop_last=True)
    ...
    es = EarlyStopping(patience=5000, mode='min', delta=1e-6)
