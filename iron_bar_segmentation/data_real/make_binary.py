...
def binary():
    ...
    while True:
        ...
        image = cv2.imread(os.path.join('./', now_folder[rand_idx]))
        ...
        image_resize = cv2.resize(image, (1200, 900))
        ...
        image_cropped = image[row:row + 256, col:col+256]
